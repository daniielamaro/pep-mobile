...
/* harmony import */ var _ionic_native_file__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ionic-native/file */ 5727);
/* harmony import */ var _ionic_native_document_viewer_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic-native/document-viewer/ngx */ 1663);
...
let CriarMedicamentoPage = class CriarMedicamentoPage {
    constructor(medicamentoService, modalController, toastController, document, urlService, router, actvRouter, storage) {
        ...
        this.router.events.subscribe((evt) => {
            if (evt instanceof _angular_router__WEBPACK_IMPORTED_MODULE_8__.NavigationEnd && this.router.url == "/page/criar-medicamento") {
                this.pageEnter();
            }
        });
    }
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            this.actvRouter.params.subscribe((params) => (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
                this.idMedicamento = params['id'];
                if (this.idMedicamento != "0") {
                    this.editando = true;
                    (yield this.medicamentoService.getMedicamentoById(this.idMedicamento))
                        .subscribe((resp) => {
                        this.nome = resp.nome;
    ...
    abrirReceita(receita) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            ...
            _ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.checkDir(_ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.externalApplicationStorageDirectory, 'Receitas')
                .then(_ => {
                _ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.writeFile(_ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.externalApplicationStorageDirectory + 'Receitas/', receita.nome, blob, { replace: true }).then(response => {
                    const options = {
                        title: 'Receita'
                    };
                    this.document.viewDocument(_ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.externalApplicationStorageDirectory + 'Receitas/' + receita.nome, receita.tipo, options);
                }).catch(err => {
                });
            })
                .catch(err => {
                _ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.createDir(_ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.externalApplicationStorageDirectory, 'Receitas', false).then(result => {
                    _ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.writeFile(_ionic_native_file__WEBPACK_IMPORTED_MODULE_6__.File.externalApplicationStorageDirectory + 'Receitas/', receita.nome, blob, { replace: true }).then(response => {
                        const options = {
                            title: 'Receita'
                        };
    ...
    editarMedicamento() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            this.showLoadingScreen()
                ...
                (yield this.medicamentoService.editarMedicamento(request))
                    .subscribe(() => {
                    this.router.navigateByUrl("/page/medicamentos");
                }, error => {
                    if (error.status == 401 || error.status == 403) {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("@charset \"UTF-8\";\n.content {\n  margin-top: 13vh;\n  width: 100%;\n  height: 77vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: flex-start;\n}\n/* Esconde o input */\n.inputfilecustom {\n  display: none;\n}\n/* Aparência que terá o seletor de arquivo */\n.inputfiletext {\n  background-color: var(--ion-color-primary) !important;\n  font-size: 14px;\n  border-radius: 5px;\n  color: #fff;\n  cursor: pointer;\n  padding: 6px;\n}\n.removerarquivo {\n  background-color: red;\n  color: #fff;\n}\n.nomearquivo {\n  word-break: break-all;\n  white-space: normal;\n}\n.inputFileArea {\n  margin-top: 10px;\n}\n.inputFileArea ion-col {\n  padding-left: 0;\n  width: 100%;\n}\n.listaTipo {\n  --placeholder-opacity: 0.5;\n}\n.item-form {\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n}\n.input-text-custom {\n  height: 30px !important;\n  max-height: 30px !important;\n}\n.input-text-right {\n  text-align: right;\n}\n.item-form-center {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.item-inner {\n  border-style: none !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
